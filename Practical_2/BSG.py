...
from utils import create_vocab, create_BSG_dataset
...
batch_size = 64
window_size = 5
vocab_size = 10000 # Top n words to use for training, all other words are mapped to <unk>, use None if you do not want to map any word to <unk>

# %% Construct vocabulary and load dataset
vocab, w2i, i2w = create_vocab(vocab_size, dataset)
targets, contexts = create_BSG_dataset(dataset, window_size, vocab, w2i)
